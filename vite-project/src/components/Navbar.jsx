...
//           <h1 className='text-3xl font-bold text-black mr-4 sm:text-4xl'>BRAND.</h1>
//           {/* <div className='md:width'> */}
//             {/* <Bars3Icon className='h-3' /> */}
...
//           <button className='bg-transparent text-indigo-600 px-6 py-3 mb-4 border-indigo-600 border-4'>Sign In</button>
